...
function begin_play(){
	...
	if(isEmpty(p1.value) == false && isEmpty(p2.value) == false){
		p1.value = p1.value + " (X)"
		p2.value = p2.value + " (O)"
		p1.disabled = true;
		p2.disabled = true;
		...
		started = true;
		  ...
		  alert("Please enter a name for Player 1 and Player 2");
	}
}
...
*/
function play() {
	var  validMove = /^[A-C][1-3]$/g; // : Fill in the regular experssion for lowerCaseLetters
	var move = document.getElementById("move_text_id").value;
	if(move.match(validMove) && document.getElementById(move).innerHTML == move && started == true){
		//if they make valid move'
		if(whose_move() == 1){
				...
				if(board_state[0] == 1 && board_state[1] == 1 && board_state[2] == 1){ //first row
					alert("X wins!");
					reset_play();
				}
				else if(board_state[3] == 1 && board_state[4] == 1 && board_state[5] == 1){ // second row
					alert("X wins!");
					reset_play();
				}
				else if(board_state[6] == 1 && board_state[7] == 1 && board_state[8] == 1){ // 3rd row
					alert("X wins!");
					reset_play();
				}
				else if(board_state[0] == 1 && board_state[3] == 1 && board_state[6] == 1){ //first col
					alert("X wins!");
					reset_play();
				}
				else if(board_state[1] == 1 && board_state[4] == 1 && board_state[7] == 1){ //second col
					alert("X wins!");
					reset_play();
				}
				else if(board_state[2] == 1 && board_state[5] == 1 && board_state[8] == 1){ //3rd col
					alert("X wins!");
					reset_play();
				}
				else if(board_state[0] == 1 && board_state[4] == 1 && board_state[8] == 1){ //diagonal top left to bottom right
					alert("O wins!");
					reset_play();
				}
				else if(board_state[6] == 1 && board_state[4] == 1 && board_state[2] == 1){ //diagonal bootom left to top right
					alert("O wins!");
					reset_play();
				}
		}
			...
			if(board_state[0] == 0 && board_state[4] == 0 && board_state[8] == 0){ //diagonal top left to bottom right
				alert("O wins!");
				reset_play();
			}
			else if(board_state[6] == 0 && board_state[4] == 0 && board_state[2] == 0){ //diagonal bootom left to top right
				alert("O wins!");
				reset_play();
			}
			else if(board_state[0] == 0 && board_state[1] == 0 && board_state[2] == 0){ //first row
				alert("O wins!");
				reset_play();
			}
			else if(board_state[3] == 0 && board_state[4] == 0 && board_state[5] == 0){ // second row
				alert("O wins!");
				reset_play();
			}
			else if(board_state[6] == 0 && board_state[7] == 0 && board_state[8] == 0){ // 3rd row
				alert("O wins!");
				reset_play();
			}
			else if(board_state[0] == 0 && board_state[3] == 0 && board_state[6] == 0){ //first col
				alert("O wins!");
				reset_play();
			}
			else if(board_state[1] == 0 && board_state[4] == 0 && board_state[7] == 0){ //second col
				alert("O wins!");
				reset_play();
			}
			else if(board_state[2] == 0 && board_state[5] == 0 && board_state[8] == 0){ //3rd col
				alert("O wins!");
				reset_play();
			}
			else if(board_state[0] == 0 && board_state[4] == 0 && board_state[8] == 0){ //diagonal top left to bottom right
				alert("O wins!");
				reset_play();
			}
			else if(board_state[6] == 0 && board_state[4] == 0 && board_state[2] == 0){ //diagonal bootom left to top right
